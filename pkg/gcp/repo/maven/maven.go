...
func Resources(ctx *pulumi.Context, input *Input) error {
	...
	mavenRepo, err := artifactregistry.NewRepository(ctx, repoName,
		&artifactregistry.RepositoryArgs{
			...
			Format:       pulumi.String(enums.GcpArtifactRegistryRepoType_MAVEN.String()),
...
func GetMavenRepoNameOutputName(repoName string) string {
	return puluminameoutputgcp.Name(artifactregistry.Repository{}, repoName,
		enums.GcpArtifactRegistryRepoType_MAVEN.String(), wordpb.Word_name.String())
}

func GetMavenRepoConfigOutputName(repoName string) string {
	return puluminameoutputgcp.Name(artifactregistry.Repository{}, repoName,
		enums.GcpArtifactRegistryRepoType_MAVEN.String(), wordpb.Word_config.String())
}

func GetMavenRepoUrlOutputName(repoName string) string {
	return puluminameoutputgcp.Name(artifactregistry.Repository{}, repoName,
		enums.GcpArtifactRegistryRepoType_MAVEN.String(), wordpb.Word_url.String())
}
